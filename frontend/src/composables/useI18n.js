...
const translations = {
  zh: {
    login: '登录',
    signing_in: '正在登录...',
    dashboard_title: 'ServiceCompose',
    dashboard_subtitle: '轻量级服务编排 · 实时监控与管控',
    login_tagline: '轻量级服务编排平台',
    login_feature_realtime: '实时指标与状态监控',
    login_feature_secure: '安全控制与权限管理',
    login_feature_overview: '多服务统一编排视图',
    live_label: '在线',
    offline_label: '离线',
    username: '用户名',
    password: '密码',
    ...
    no_core_data: '暂无核心数据',
    sysinfo_title: '系统信息',
    statusbar_net_io: '网络 IO',
    statusbar_disk_io: '磁盘 IO',
    statusbar_cpu_hot: 'CPU 满载核 (≥90%)',
    statusbar_mem: '内存使用',
    statusbar_disk: '磁盘使用 (运行目录)',
    sysinfo_os: '操作系统',
    sysinfo_distro: '发行版',
    sysinfo_kernel: '内核',
    sysinfo_arch: '架构',
    ...
    sysinfo_net_download: '下载',
    sysinfo_net_upload: '上传',
    sysinfo_net_total: '累计',
  ...
  en: {
    ...
    dashboard_title: 'ServiceCompose',
    dashboard_subtitle: 'Lightweight Service Orchestration · Real-time Monitoring & Control',
    login_tagline: 'Lightweight Service Orchestration',
    login_feature_realtime: 'Real-time metrics & status monitoring',
    login_feature_secure: 'Secure control & permission management',
    login_feature_overview: 'Unified multi-service orchestration view',
    live_label: 'Live',
    ...
    statusbar_net_io: 'Network IO',
    statusbar_disk_io: 'Disk IO',
    statusbar_cpu_hot: 'CPU Hot Cores (≥90%)',
    statusbar_mem: 'Memory Usage',
    statusbar_disk: 'Disk Usage (Run Dir)',
    ...
    sysinfo_net_download: 'Down',
    sysinfo_net_upload: 'Up',
    sysinfo_net_total: 'Total',
